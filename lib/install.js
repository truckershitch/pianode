...
//            });
    ...
    function downloadPianobar() {
        console.log('Downloading latest pianobar at: ');
        //ghdownload('https://github.com/PromyLOPh/pianobar.git#2016.06.02', path.resolve(installRoot, 'pianobar'))
        ghdownload({user: 'PromyLOPh', repo: 'pianobar', ref: '2016.06.02'}, path.resolve(installRoot, 'pianobar'))
                .on('dir', function (dir) {
                    console.log(dir);
                })
